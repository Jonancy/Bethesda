...
export default function Footer({
  ...
  return (
    <footer className="bg-primaryColor ">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-between px-4 sm:px-8 md:px-16 lg:px-20 py-10">
        ...
        <div className="mb-8 md:mb-0">
          <div className="mt-4 mb-2 font-medium xl:mb-4 text-white text-2xl md:text-3xl">
            About
          </div>
        ...
        <div className="mt-8 md:mt-0 text-gray-500">
          <div className="mt-4 mb-2 font-medium xl:mb-4">
            <p className="text-2xl md:text-3xl text-white">Get in Touch</p>
      ...
      <div className="bg-secondaryColor">
        <div className="mx-auto flex max-w-screen-xl flex-col gap-y-4 px-4 py-3 text-center text-gray-500 sm:px-8 md:px-16 lg:px-20 lg:flex-row lg:justify-between lg:text-left xl:px-10">
